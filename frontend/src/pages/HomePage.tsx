    ...
    <div className="dashboard-layout">
      ...
      <div className="mobile-only" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 24 }}>
        ...
        <button 
          ...
          style={{ border: '1px solid var(--color-border)', background: 'var(--color-bg)', width: 44, height: 44, borderRadius: '50%', display: 'flex', alignItems: 'center', justifyContent: 'center' }}
        >
          <SettingsIcon />
        </button>
      </div>
